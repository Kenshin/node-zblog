...
exports.xml_to_categorylist = function( xml ) {
   ...
   try {
      ...
      console.log( 'xml_to_categorylist_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'xml_to_categorylist' );
   }
...
exports.xml_to_archivelist = function ( xml ) {
   try {
      ...
      console.log( 'xml_to_archivelist_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'xml_to_archivelist' );
   }
}
...
exports.xml_to_article_detail = function ( xml ) {
   try {
      ...
      console.log( 'xml_to_article_detail_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'xml_to_article_detail' );
   }
}
...
exports.xml_to_articlelist = function ( xml ) {
   try {
      ...
      console.log( 'xml_to_articlelist_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'xml_to_articlelist' );
   }
...
exports.xml_to_srch_result = function ( xml ) {
   try {
      ...
      console.log( 'xml_to_srch_result_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'xml_to_srch_result' );
   }
}
...
exports.article_count = function ( xml ) {
   try {
      ...
      console.log( 'article_count_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'article_count' );
   }
}
...
exports.xml_to_commentlist = function ( xml ) {
   try {
      ...
      console.log( 'xml_to_commentlist_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'xml_to_commentlist' );
   }
}
...
exports.xml_to_statistics = function ( xml ) {
   try {
      ...
      console.log( 'xml_to_statistics_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'xml_to_statistics' );
   }
}
...
exports.xml_to_tags = function ( xml ) {
   try {
      ...
      console.log( 'xml_to_tags_err.message = ' + err.message )
      return get_error_vo( 'error', err.message, 'xml_to_tags' );
   }
}
...
function get_error_vo( error, message, name ) {
   var error = new vo.error( error, message, name );
   return error;
}
